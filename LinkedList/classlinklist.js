...
class LinkedList {
  ...
  insertFirst(data) {
    ...
    // and if there is no previous head this.head remains null
    // but if there is a previously existing this.head...
    // then it becomes this.head.next
  ...
  // clear
  clearList() {
    // Reset the values of LinkedList to nothing
    this.head = null;
    this.size = 0;
    return;
  }
